 ...
 * Generated at: 2016-12-18 15:27:55 UTC
...
public final class danh_002dsach_002dde_002dtai_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("<html>\r\n");
      out.write("<head>\r\n");
      out.write("<title>Danh sách đề tài</title>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"tenDeTai\">\r\n");
      out.write("\t\t\t\t\t\t\t\t <span class=\"input-group-btn\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<button class=\"btn btn-default form-control\" type=\"button\" id=\"searchBtn\">\r\n");
      out.write("\t\t\t\t\t\t\t\t   <i class=\"fa fa-search\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<a href=\"/tim-kiem-nang-cao\"><button type=\"button\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"btn btn btn-primary\">Tìm kiếm nâng cao</button></a>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th><p >Mã đề tài</p></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th style=\"width:30%;\"><p align=\"center\">Tên đề tài</p></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th><p>Tên tác giả</p></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th><p>Loại đề tài</p></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th><p>Hướng nghiên cứu</p></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th style=\"width: 200px;\"><p>Thời gian</p></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th><p>Trạng thái</p></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th></th>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t</thead>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<tr >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>KH04</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>Đề tài về xử lý tiếng nói abcugdw ggqgdq ygqsd ysv\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tgqwd ywqgdss svqsuj</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>Lê Văn Thắng</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>Cấp trường</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>Nghiên cứu cơ bản</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>22/11/2016 - 12/12/2016</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>Đang thực hiện</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td><a href=\"detail_topic.html\"><button type=\"button\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"btn btn-sm btn-info\">Xem</button> </a></td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t\t</table>\r\n");
      ...
      out.write("\t<script src=\"/assets/js/user/tim-kiem-de-tai.js\" type=\"text/javascript\"></script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
